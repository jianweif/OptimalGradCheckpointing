...
![scheme_compare](./figures/scheme_compare_gradient_checkpoint.png){:height="50%" width="50%"}
![table_compare](./figures/table_compare_gradient_checkpoint.png){:height="50%" width="50%"}
